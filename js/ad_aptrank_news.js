...
function load_parrtnership(){
    part_url = "https://www.realrankus.com/ad/1000000000_Korea_ad.json"
...
function show_partnership(){
 ...
 if(partData.data.length > 0 && (today_num >= part_sDate_Num && today_num <= part_eDate_Num) ){
    ...
    if(part_type == 'Static_Pop'){
      $('#themeDataList').append(part_static_pop);
    }
    if(part_type == 'Static_Pop2'){
    $('#themeDataList').append(part_static_pop2);
    }
