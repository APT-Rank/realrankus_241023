...
function openSimulation(arr, index){
  ...
  */
  ...
  //학원
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + "300m 이내 학원" + "</div>" + "<div class='popResult'><select class='optionSelect' id='academyOption' onChange='putVal(this)'>"
  for(var i = 0 ; i < academy_option.length ; i++){
    detailHtml += "<option value=" + i + ">" + academy_option[i][0] + "</option>"
  }
  detailHtml += "</select></div></div>"

  detailHtml += "<div class='popSubTable'><div class='popContent'>" + "1km 이내 학원" + "</div>" + "<div class='popResult'><select class='optionSelect' id='academyOption_long' onChange='putVal(this)'>"
  for(var i = 0 ; i < academy_option.length ; i++){
    detailHtml += "<option value=" + i + ">" + academy_option[i][0] + "</option>"
  }
  detailHtml += "</select></div></div>"  
