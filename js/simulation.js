function tOption(val) {
  ...
  var dict = {
    ...
    "초역세권": "Premium Area",
    "역세권": "Standard Area",
    "준역세권": "Sub-standard Area",
    "비역세권": "Not Near Area",
    "많은 전입": "Heavy net in-migration",
    "적은 전입": "Light net in-migration",
    "변화 적음": "Stable enrollment",
    "적은 전출": "Light net out-migration",
    "많은 전출": "Heavy net out-migration",
    "없음": "None"
  };
  
  if (dict[cleanVal] !== undefined) {
    return dict[cleanVal];
  }
  
  if (cleanVal.indexOf("년차") !== -1) {
    if (cleanVal === "30년차 이상") return "30 years+";
    return cleanVal.replace("년차", " years");
  }
  
  if (cleanVal.indexOf("세대") !== -1) {
    if (cleanVal === "1500세대 이상") return "1500 households+";
    return cleanVal.replace("세대", " households");
  }
  
  if (cleanVal.indexOf("대") !== -1) {
    if (cleanVal === "2.6대 이상") return "2.6 cars+";
    return cleanVal.replace("대", " cars");
  }

  if (cleanVal.indexOf("개") !== -1) {
    if (cleanVal.indexOf("이상") !== -1) {
      return cleanVal.replace("개 이상", "+");
    }
    return cleanVal.replace("개", "");
  }

  if (cleanVal.indexOf("00m") !== -1) {
    return cleanVal.replace("이상", "+");
  }

  if (cleanVal.indexOf("점") !== -1) {
    return cleanVal.replace("점", " pts");
  }
...
function openLoading() {
  ...
  loadingImg += "<div id='loadingTxt' style='text-align: center; color: white; font-size: 1.2em; font-weight: 600; margin-top: 10px'>" + t("ui.analyzing", "열심히 분석 중이예요!") + "</div>"
  loadingImg += "</div>";
  //레이어 추가
  $('body')
    .append(mask)
...
function openSimulation(arr, index) {
  ...
  var road_address = arr[index]["도로명주소"]
  var law_address = arr[index]["법정동주소"]
  ...
  if(isEn){
    aptName = arr[index]["APT_Name_EN"]
    law_address = arr[index]["Law_Addr_EN"]
  }
  ...
  titleHtml += "<div class='popupTitle' style='color: #fe4040; font-size: 0.6em; text-align: center; border-bottom: 1px solid #fe4040; border-top: 1px solid #fe4040;margin-bottom: 3px'>" + t("ui.rank_simulation", "랭크 시뮬레이션") + "</div>";
  ...
  if (apt_type == "분양권") {
    titleHtml += "<div class='popupSubtitle' style='font-size: 0.6em; text-align: center'>" + law_address + "</div>";
  }
  else {
    titleHtml += "<div class='popupSubtitle' style='font-size: 0.6em; text-align: center'>" + law_address + "</div>";
  }
  ...
  detailHtml += "<div class='popTitle'><i class='fas fa-home'></i>&nbsp&nbsp" + t("ui.living", "주거") + "</div>"
  detailHtml += "</div>";
  ...
  //조망 프리미엄 선택
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.view_premium_label", "조망 프리미엄") + "</div>" + "<div class='popResult'><select class='optionSelect' id='viewOption' onChange='putVal(this)'>"
  for (var i = 0; i < premiumOption.length; i++) {
    detailHtml += "<option value=" + i + ">" + tOption(premiumOption[i][0]) + "</option>"
  }
  ...
  //연차선택
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.age_label", "연차") + "</div>" + "<div class='popResult'><select class='optionSelect' id='yearOption' onChange='putVal(this)'>"
  for (var i = 0; i < yearOption.length; i++) {
    detailHtml += "<option value=" + i + ">" + tOption(yearOption[i][0]) + "</option>"
  }
  detailHtml += "</select></div></div>"

  //detailHtml += "<div class='popSubTable'><div class='popContent'>" + "세대수" + "</div>" + "<div class='popResult'>" + house_num.toLocaleString() + "세대</div></div>";
  //세대수선택
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.house_num_label", "세대수") + "</div>" + "<div class='popResult'><select class='optionSelect' id='houseNumOption' onChange='putVal(this)'>"
  for (var i = 0; i < houseOption.length; i++) {
    detailHtml += "<option value=" + i + ">" + tOption(houseOption[i][0]) + "</option>"
  }
  detailHtml += "</select></div></div>"

  //detailHtml += "<div class='popSubTable' id='popSubStation'><div class='popContent'>" + "주차" + "</div>" + "<div class='popResult'>" + parking + "</div></div>";
  //주차선택
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.parking_per_house", "세대당 주차수") + "</div>" + "<div class='popResult'><select class='optionSelect' id='parkingOption' onChange='putVal(this)'>"
  for (var i = 0; i < parkingOption.length; i++) {
    detailHtml += "<option value=" + i + ">" + tOption(parkingOption[i][0]) + "</option>"
  }
  detailHtml += "</select></div></div>"

  //detailHtml += "<div class='popSubTable'><div class='popContent'>" + "난방방식" + "</div>" + "<div class='popResult'>" + heating + "</div></div>";
  //난방선택
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.heating_label", "난방방식") + "</div>" + "<div class='popResult'><select class='optionSelect' id='heatingOption' onChange='putVal(this)'>"
  for (var i = 0; i < heatingOption.length; i++) {
    detailHtml += "<option value=" + i + ">" + tOption(heatingOption[i][0]) + "</option>"
  }
  detailHtml += "</select></div></div>"

  //detailHtml += "<div class='popSubTable'><div class='popContent'>" + "현관구조" + "</div>" + "<div class='popResult'>" + entrance + "</div></div>";
  //현관선택
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.entrance_label", "현관구조") + "</div>" + "<div class='popResult'><select class='optionSelect' id='entranceOption' onChange='putVal(this)'>"
  for (var i = 0; i < entranceOption.length; i++) {
    detailHtml += "<option value=" + i + ">" + tOption(entranceOption[i][0]) + "</option>"
  }
  detailHtml += "</select></div></div>"

  //추가 주거 가점
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.give_custom_living_bonus", "내맘대로 주거 가점 주기") + "</div>" + "<div class='popResult'><select class='optionSelect' id='livingAddOption' onChange='putVal(this)'>"
  for (var i = 0; i < add_option.length; i++) {
    detailHtml += "<option value=" + i + ">" + tOption(add_option[i][0]) + "</option>"
  }
  detailHtml += "</select></div></div>"
  ...
  */
  ...
  if (stationArea != "NA") {
    ...
    detailHtml += "<div class='card'>";
    detailHtml += "<div class='card-header'>";
    detailHtml += "<div class='popTitle'><i class='fas fa-bus'></i>&nbsp&nbsp" + t("ui.transport", "교통") + "</div>"
    detailHtml += "</div>";
    detailHtml += "<div class='card-body'>";
    ...
    //가까운역선택
    detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.station_area_label", "역세권 여부") + "</div>" + "<div class='popResult'><select class='optionSelect' id='subwayOption' onChange='putVal(this)'>"
    for (var i = 0; i < cloestStationOption.length; i++) {
      detailHtml += "<option value=" + i + ">" + tOption(cloestStationOption[i][0]) + "</option>"
    }
    detailHtml += "</select></div></div>"
    ...
    //30분 이내 도착 가능
    detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.major_stations_30m", "30분 이내 도착 가능 주요역") + "</div>" + "<div class='popResult'><select class='optionSelect' id='min30Option' onChange='putVal(this)'>"
    for (var i = 0; i < station_30m_Option.length; i++) {
      detailHtml += "<option value=" + i + ">" + station_30m_Option[i][0] + (isEn ? "" : "개") + "</option>"
    }
    detailHtml += "</select></div></div>"
    ...
    //30분 이내 도착 가능
    detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.major_stations_1h", "1시간 이내 도착 가능 주요역") + "</div>" + "<div class='popResult'><select class='optionSelect' id='hour1Option' onChange='putVal(this)'>"
    for (var i = 0; i < station_1h_Option.length; i++) {
      detailHtml += "<option value=" + i + ">" + station_1h_Option[i][0] + (isEn ? "" : "개") + "</option>"
    }
    detailHtml += "</select></div></div>"

    //추가 교통 가점
    detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.give_custom_trans_bonus", "내맘대로 교통 가점 주기") + "</div>" + "<div class='popResult'><select class='optionSelect' id='transAddOption' onChange='putVal(this)'>"
    for (var i = 0; i < add_option.length; i++) {
      detailHtml += "<option value=" + i + ">" + tOption(add_option[i][0]) + "</option>"
    }
    detailHtml += "</select></div></div>"
  ...
  detailHtml += "<div class='card'>";
  detailHtml += "<div class='card-header'>";
  detailHtml += "<div class='popTitle'><i class='fas fa-hospital-user'></i>&nbsp&nbsp" + t("ui.infra", "인프라") + "</div>"
  detailHtml += "</div>";
  detailHtml += "<div class='card-body'>";
  ...
  //백화점
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.dept_store_3km", "3km 이내 백화점") + "</div>" + "<div class='popResult'><select class='optionSelect' id='departmentOption' onChange='putVal(this)'>"
  for (var i = 0; i < department_option.length; i++) {
    detailHtml += "<option value=" + i + ">" + department_option[i][0] + (isEn ? "" : "개") + "</option>"
  }
  detailHtml += "</select></div></div>"

  //detailHtml += "<div class='popSubTable'><div class='popContent'>" + "5km 이내 아울렛/몰" + "</div>" + "<div class='popResult'>" + OutletMall_5km + "</div></div>";
  //아울렛/몰
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.outlet_mall_5km", "5km 이내 아울렛/몰") + "</div>" + "<div class='popResult'><select class='optionSelect' id='outletOption' onChange='putVal(this)'>"
  for (var i = 0; i < outlet_option.length; i++) {
    detailHtml += "<option value=" + i + ">" + outlet_option[i][0] + (isEn ? "" : "개") + "</option>"
  }
  detailHtml += "</select></div></div>"

  //detailHtml += "<div class='popSubTable'><div class='popContent'>" + "1km 이내 대형마트" + "</div>" + "<div class='popResult'>" + bigMart_1km + "</div></div>";
  //대형마트
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.mart_1km", "1km 이내 대형마트") + "</div>" + "<div class='popResult'><select class='optionSelect' id='bigMartOption' onChange='putVal(this)'>"
  for (var i = 0; i < bigMart_option.length; i++) {
    detailHtml += "<option value=" + i + ">" + bigMart_option[i][0] + (isEn ? "" : "개") + "</option>"
  }
  detailHtml += "</select></div></div>"
  ...
  */
  //상권
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.stores_300m", "300m 이내 상점") + "</div>" + "<div class='popResult'><select class='optionSelect' id='marketOption' onChange='putVal(this)'>"
  for (var i = 0; i < market_option.length; i++) {
    detailHtml += "<option value=" + i + ">" + tOption(market_option[i][0]) + "</option>"
  }
  detailHtml += "</select></div></div>"

  //detailHtml += "<div class='popSubTable'><div class='popContent'>" + "500m 이내 은행" + "</div>" + "<div class='popResult'>" + bank_500m + "</div></div>";
  //은행
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.banks_500m", "500m 이내 은행") + "</div>" + "<div class='popResult'><select class='optionSelect' id='bankOption' onChange='putVal(this)'>"
  for (var i = 0; i < bank_option.length; i++) {
    detailHtml += "<option value=" + i + ">" + bank_option[i][0] + (isEn ? "" : "개") + "</option>"
  }
  detailHtml += "</select></div></div>"

  //detailHtml += "<div class='popSubTable'><div class='popContent'>" + "500m 이내 병원" + "</div>" + "<div class='popResult'>" + hospital_500m + "</div></div>";
  //병원
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.hospitals_500m", "500m 이내 병원") + "</div>" + "<div class='popResult'><select class='optionSelect' id='hospitalOption' onChange='putVal(this)'>"
  for (var i = 0; i < hospital_option.length; i++) {
    detailHtml += "<option value=" + i + ">" + tOption(hospital_option[i][0]) + "</option>"
  }
  detailHtml += "</select></div></div>"

  //detailHtml += "<div class='popSubTable'><div class='popContent'>" + "5km 이내 대형병원" + "</div>" + "<div class='popResult'>" + bigHospital_5km + "</div></div>";
  //대형병원
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.large_hospitals_5km", "5km 이내 대형병원") + "</div>" + "<div class='popResult'><select class='optionSelect' id='bigHospitalOption' onChange='putVal(this)'>"
  for (var i = 0; i < bigHospital_option.length; i++) {
    detailHtml += "<option value=" + i + ">" + bigHospital_option[i][0] + (isEn ? "" : "개") + "</option>"
  }
  detailHtml += "</select></div></div>"

  //detailHtml += "<div class='popSubTable'><div class='popContent'>" + "500m 이내 공원" + "</div>" + "<div class='popResult'>" + park_500m + "</div></div>";
  //공원
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.parks_500m", "500m 이내 공원") + "</div>" + "<div class='popResult'><select class='optionSelect' id='parkOption' onChange='putVal(this)'>"
  for (var i = 0; i < park_option.length; i++) {
    detailHtml += "<option value=" + i + ">" + park_option[i][0] + (isEn ? "" : "개") + "</option>"
  }
  detailHtml += "</select></div></div>"

  //detailHtml += "<div class='popSubTable'><div class='popContent'>" + "1km 이내 대형공원" + "</div>" + "<div class='popResult'>" + big_park_1km + "</div></div>";
  //대형공원
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.large_parks_1km", "1km 이내 대형공원") + "</div>" + "<div class='popResult'><select class='optionSelect' id='bigParkOption' onChange='putVal(this)'>"
  for (var i = 0; i < bigPark_option.length; i++) {
    detailHtml += "<option value=" + i + ">" + bigPark_option[i][0] + (isEn ? "" : "개") + "</option>"
  }
  detailHtml += "</select></div></div>"

  //detailHtml += "<div class='popSubTable'><div class='popContent'>" + "3km 이내 혐오시설" + "</div>" + "<div class='popResult'>" + harmful_3km + "</div></div>";
  //혐오시설
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.harmful_facility_3km", "3km 이내 혐오시설") + "</div>" + "<div class='popResult'><select class='optionSelect' id='harmfulOption' onChange='putVal(this)'>"
  for (var i = 0; i < harmful_option.length; i++) {
    detailHtml += "<option value=" + i + ">" + harmful_option[i][0] + (isEn ? "" : "개") + "</option>"
  }
  detailHtml += "</select></div></div>"

  //추가 인프라 가점
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.give_custom_infra_bonus", "내맘대로 인프라 가점 주기") + "</div>" + "<div class='popResult'><select class='optionSelect' id='infraAddOption' onChange='putVal(this)'>"
  for (var i = 0; i < add_option.length; i++) {
    detailHtml += "<option value=" + i + ">" + tOption(add_option[i][0]) + "</option>"
  }
  detailHtml += "</select></div></div>"
  ...
  detailHtml += "<div class='card'>";
  detailHtml += "<div class='card-header'>";
  detailHtml += "<div class='popTitle'><i class='fas fa-graduation-cap'></i>&nbsp&nbsp" + t("ui.edu", "교육") + "</div>"
  detailHtml += "</div>";
  detailHtml += "<div class='card-body'>";
  ...
  //초등학교 거리
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.elem_school_dist", "초등학교 거리") + "</div>" + "<div class='popResult'><select class='optionSelect' id='pSchoolDistOption' onChange='putVal(this)'>"
  for (var i = 0; i < pSchool_dist_option.length; i++) {
    detailHtml += "<option value=" + i + ">" + tOption(pSchool_dist_option[i][0]) + "</option>"
  }
  detailHtml += "</select></div></div>"
  ...
  //초등학교 학생증감
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.elem_school_student_change", "초등학교 학생증감") + "</div>" + "<div class='popResult'><select class='optionSelect' id='pSchoolEduOption' onChange='putVal(this)'>"
  for (var i = 0; i < pSchool_edu_option.length; i++) {
    detailHtml += "<option value=" + i + ">" + tOption(pSchool_edu_option[i][0]) + "</option>"
  }
  detailHtml += "</select></div></div>"

  //detailHtml += "<div class='popSubTable'><div class='popContent'>" + "중학교 학업성취도" + "</div>" + "<div class='popResult'>" + mSchool_edu + "</div></div>";
  //중학교 성취도
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.elem_school_achievement", "중학교 학업성취도") + "</div>" + "<div class='popResult'><select class='optionSelect' id='mSchoolEduOption' onChange='putVal(this)'>"
  for (var i = 0; i < mSchool_option.length; i++) {
    detailHtml += "<option value=" + i + ">" + tOption(mSchool_option[i][0]) + "</option>"
  }
  detailHtml += "</select></div></div>"

  //detailHtml += "<div class='popSubTable'><div class='popContent'>" + "500m 이내 학원가" + "</div>" + "<div class='popResult'>" + academy_edu + "</div></div>";  
  //학원
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.academies_300m", "300m 이내 학원") + "</div>" + "<div class='popResult'><select class='optionSelect' id='academyOption' onChange='putVal(this)'>"
  for (var i = 0; i < academy_option.length; i++) {
    detailHtml += "<option value=" + i + ">" + tOption(academy_option[i][0]) + "</option>"
  }
  detailHtml += "</select></div></div>"

  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.academies_1km", "1km 이내 학원") + "</div>" + "<div class='popResult'><select class='optionSelect' id='academyOption_long' onChange='putVal(this)'>"
  for (var i = 0; i < academy_option.length; i++) {
    detailHtml += "<option value=" + i + ">" + tOption(academy_option[i][0]) + "</option>"
  }
  detailHtml += "</select></div></div>"
  ...
  //유흥시설, 모텔
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.harmful_facility_300m", "300m 유흥시설/모텔") + "</div>" + "<div class='popResult'><select class='optionSelect' id='drinkMotelOption' onChange='putVal(this)'>"
  for (var i = 0; i < drink_motel_option.length; i++) {
    detailHtml += "<option value=" + i + ">" + drink_motel_option[i][0] + (isEn ? "" : "개") + "</option>"
  }
  detailHtml += "</select></div></div>"

  //추가 교육 가점
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.give_custom_edu_bonus", "내맘대로 교육 가점 주기") + "</div>" + "<div class='popResult'><select class='optionSelect' id='eduAddOption' onChange='putVal(this)'>"
  for (var i = 0; i < add_option.length; i++) {
    detailHtml += "<option value=" + i + ">" + tOption(add_option[i][0]) + "</option>"
  }
  detailHtml += "</select></div></div>"
  ...
  */
  ...
  footerHtml += "<div></div>"
  footerHtml += "<div><button type='button' class='goApt' onclick='calValue(arrrr," + arr.length + ")'>" + t("ui.view_result", "결과 보기") + "</button></div>"
  footerHtml += "<div></div>"
  footerHtml += "</div>"
  ...
  eduSelections(arr[index]["초등학교거리"], arr[index]["초등학교학업성취도"], arr[index]["중학교학업성취도"], arr[index]["500m이내학원수"], arr[index]["1km이내학원수"], (drink_pub + daran_pub + motel))
...
function eduSelections(pSchool_dist, pSchool_edu, mSchool_edu, academy, academy_long, drink_motel) {
  ...
  academy_long_value = 0
  if (academy_long >= 0 && academy_long <= 19) {
    academy_value = 0
  }
  else if (academy_long >= 20 && academy_long <= 39) {
    academy_long_value = 1
  }
  else if (academy_long >= 40 && academy_long <= 59) {
    academy_long_value = 2
  }
  else if (academy_long >= 60 && academy_long <= 79) {
    academy_long_value = 3
  }
  else if (academy_long >= 80 && academy_long <= 99) {
    academy_long_value = 4
  }
  else if (academy_long >= 100 && academy_long <= 119) {
    academy_long_value = 5
  }
  else if (academy_long >= 120 && academy_long <= 139) {
    academy_long_value = 6
  }
  else if (academy_long >= 140 && academy_long <= 159) {
    academy_long_value = 7
  }
  else {
    academy_long_value = 8
  }
  $('#academyOption_long').val(academy_long_value).prop('selected', true)
  simul_edu_score.push([academy_option[academy_long_value][0], academy_option[academy_long_value][1]])
...
function putVal(e) {
  ...
  if (e.id == "drinkMotelOption") {
    simul_edu_score[5][0] = drink_motel_option[e.value][0]
    simul_edu_score[5][1] = drink_motel_option[e.value][1]
  }
  if (e.id == "eduAddOption") {
    simul_edu_score[6][0] = add_option[e.value][0]
    simul_edu_score[6][1] = add_option[e.value][1]
  }
  if (e.id == "academyOption_long") {
    simul_edu_score[4][0] = academy_option[e.value][0]
    simul_edu_score[4][1] = academy_option[e.value][1]
  }
}
...
function calValue(arr, length) {
  ...
  pAcademy_score = (simul_edu_score[3][1] * 0.75) + (simul_edu_score[4][1] * 0.25)
  edu_score = ((pSchool_score * education_rate['primary_school']) + (simul_edu_score[2][1] * education_rate['middle_school']) +
    (pAcademy_score * education_rate['academy']) + (simul_edu_score[5][1] * education_rate['harmful'] * (-1)) + simul_edu_score[6][1])
...
function showSimulResult(resultValue, arr, length) {
  ...
  let aptName = arr["아파트명"]
  let law_address = arr["법정동주소"]

  if(isEn){
    aptName = arr["APT_Name_EN"]
    law_address = arr["Law_Addr_EN"]
  }
  ...
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.view_premium_label", "조망 프리미엄") + "</div>" + "<div class='popResult'>" + tOption(simul_living_score[0][0]) + "</div></div>";
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.age_label", "연차") + "</div>" + "<div class='popResult'>" + tOption(simul_living_score[1][0]) + "</div></div>";
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.house_num_label", "세대수") + "</div>" + "<div class='popResult'>" + tOption(simul_living_score[2][0]) + "</div></div>";
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.parking_per_house", "세대당 주차수") + "</div>" + "<div class='popResult'>" + tOption(simul_living_score[3][0]) + "</div></div>";
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.heating_label", "난방방식") + "</div>" + "<div class='popResult'>" + tOption(simul_living_score[4][0]) + "</div></div>";
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.entrance_label", "현관구조") + "</div>" + "<div class='popResult'>" + tOption(simul_living_score[5][0]) + "</div></div>";
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.custom_living_bonus", "내맘대로 주거 가점") + "</div>" + "<div class='popResult'>" + tOption(simul_living_score[6][0]) + "</div></div>";
  detailHtml += "</div></div></div></div>";
  ...
  if (resultValue[2][0] != 0) {
    ...
    detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.nearest_station_dist", "가장 가까운 역 거리") + "</div>" + "<div class='popResult'>" + tOption(simul_trans_score[0][0]) + "</div></div>";
    ...
    detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.custom_trans_bonus", "내맘대로 교통 가점") + "</div>" + "<div class='popResult'>" + tOption(simul_trans_score[3][0]) + "</div></div>";
    detailHtml += "</div></div></div></div>";
  }
  ...
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.stores_300m", "300m 이내 상점") + "</div>" + "<div class='popResult'> " + tOption(simul_infra_score[3][0]) + "</div></div>";
  ...
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.hospitals_500m", "500m 이내 병원") + "</div>" + "<div class='popResult'>" + tOption(simul_infra_score[5][0]) + "</div></div>";
  ...
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.custom_infra_bonus", "내맘대로 인프라 가점") + "</div>" + "<div class='popResult'>" + tOption(simul_infra_score[10][0]) + "</div></div>";
  detailHtml += "</div></div></div></div>"
  ...
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.elem_school_dist", "초등학교 거리") + "</div>" + "<div class='popResult'>" + tOption(simul_edu_score[0][0]) + "</div></div>";
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.elem_school_student_change", "초등학교 학생증감") + "</div>" + "<div class='popResult'>" + tOption(simul_edu_score[1][0]) + "</div></div>";
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.elem_school_achievement", "중학교 학업성취도") + "</div>" + "<div class='popResult'>" + tOption(simul_edu_score[2][0]) + "</div></div>";
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.academies_300m", "300m 이내 학원") + "</div>" + "<div class='popResult'>" + tOption(simul_edu_score[3][0]) + "</div></div>";
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.academies_1km", "1km 이내 학원") + "</div>" + "<div class='popResult'>" + tOption(simul_edu_score[4][0]) + "</div></div>";
  ...
  detailHtml += "<div class='popSubTable'><div class='popContent'>" + t("ui.custom_edu_bonus", "내맘대로 교육 가점") + "</div>" + "<div class='popResult'>" + tOption(simul_edu_score[6][0]) + "</div></div>";
  detailHtml += "</div></div></div></div>"
