...
var biz_title_aptrank_list = "아파트 입지평가 TOP7 이란?"
var biz_info_aptrank_list =
"<ul style='padding-left: 13px'>"
+"<li>리얼랭커스 알고리즘를 통해 '주거', '인프라', '교통', '교육'의 요소들을 수치로 계산하여 7위까지의 순위 단지를 표시합니다.<br><br>"

+"<li>[리얼랭커스 입지 평가 항목]<br>"
+"ㆍ주거 = 세대수, 입주년차, 주차수, 난방방식, 욕실수, 현관구조 (재건축은 용적률과 건폐율로 계산)<br>"
+"ㆍ인프라 = 백화점, 아울렛, 몰, 대형마트, 은행, 병원, 종합병원, 공원, 대형공원, 혐오시설<br>"
+"ㆍ교육 = 초등학교 전출입비, 초등학교 거리, 중학교 학업성취도, 학원가, 학원 개수, (감점)유흥시설 및 모텔 개수<br>"
+"ㆍ교통(수도권/광역시) = 역세권 여부, 30분이내 도착 가능 거점역, 1시간 이내 도착 가능 거점역, 역세권 노선 중요도<br>"
+"</ul>"
+"<hr style='padding: 0px'>"
+"<li>데이터 알고리즘: 리얼랭커스"

var biz_title_sales_rent_index = "KB부동산 매매/전세 지수란?"
var biz_info_sales_rent_index =
"<ul style='padding-left: 13px'>"
+"<li>KB부동산에서 월 1회 제공되는 부동산 종합 현황 지수로, 2022년 1월의 가격을 100.0으로 설정한 기준으로 산정됩니다<br>"
+"<li>100초과는 매수우위, 100미만은 매도우위를 의미합니다.<br>"
+"</ul>"
+"<hr style='padding: 0px'>"
+"<li>자료출처: KB부동산<br>"
