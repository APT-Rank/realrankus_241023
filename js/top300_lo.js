...
function showTopDetail(index){
  ...
  detailHtml += "<div class='graph' style='height: 100px'> <canvas id='valueChart'></canvas></div>"
  ...
  */
  ...
  //drawSubChart(livingScore, "", "주거총점", "TOP300 평균", "#fe4040", "#9f9f9f",  "livingChart")
  //if(transportScore != 0){
  //  drawSubChart(transportScore, "", "교통총점", "TOP300 평균", "#fe4040", "#9f9f9f", "transportChart")
  //}
  //drawSubChart(infraScore, "", "인프라총점", "TOP300 평균", "#fe4040", "#9f9f9f", "infraChart")
  //drawSubChart(eduScore, "", "교육총점", "TOP300 평균", "#fe4040", "#9f9f9f", "eduChart")
