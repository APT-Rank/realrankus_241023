  ...
  */
  ...
  function showSorting(){
    ...
    detailHtml += "<div><input type='radio' class='btn-check' name='btnSort' autocomplete='off' id='sortLiving' onClick='setRangeValue(this)'><label class='btn btn-outline-primary' for='sortLiving'>주거우선</label></div>"
    ...
    if(selectedRegion == 'Seoul' || selectedRegion == 'Incheon' || selectedRegion == 'Gyeonggi' || selectedRegion == 'Busan' || selectedRegion == 'Daegu' || selectedRegion == 'Daejeon' || selectedRegion == 'Gwangju'){
      detailHtml += "<div><input type='radio' class='btn-check' name='btnSort' autocomplete='off' id='sortTrans' onClick='setRangeValue(this)'><label class='btn btn-outline-primary' for='sortTrans'>교통우선</label></div>"
    }

    detailHtml += "<div><input type='radio' class='btn-check' name='btnSort' autocomplete='off' id='sortInfra' onClick='setRangeValue(this)'><label class='btn btn-outline-primary' for='sortInfra'>인프라우선</label></div>"
    detailHtml += "<div><input type='radio' class='btn-check' name='btnSort' autocomplete='off' id='sortEdu' onClick='setRangeValue(this)'><label class='btn btn-outline-primary' for='sortEdu'>교육우선</label></div>"
    detailHtml += "<div><input type='radio' class='btn-check' name='btnSort' autocomplete='off' id='sortCustom' onClick='setRangeValue(this)'><label class='btn btn-outline-primary' for='sortCustom'>커스텀</label></div>"
    detailHtml += "<div><input type='radio' class='btn-check' name='btnSort' autocomplete='off' id='sortDefault' onClick='setRangeValue(this)'><label class='btn btn-outline-primary' for='sortDefault'>균형잡힌</label></div>"
    detailHtml += "</div>";
    ...
    footerHtml += "<div><button type='button' id='sortClose' class='btn btn-outline-primary' onClick='closeSorting()'>닫기</button></div>"
    footerHtml += "<div><button type='button' id='sortApply' class='btn btn-outline-primary' onClick='applySorting()'>적용</button></div>"    
    footerHtml += "</div>"    
