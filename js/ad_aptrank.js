var part_default = 
"<div class='partBox' style='border-radius: 8px; background-color: #eee;' onClick=\"goMap('https://forms.gle/7d9Am6RzXfBAsa6e7')\">"
...
function load_parrtnership(region){
    /*
    if (region == "1168000000_Seoul_Gangnam" || region == "1174000000_Seoul_Gangdong"  || region == "1171000000_Seoul_Songpa"  || region == "2818500000_Incheon_Yeonsu"
    || region == "4159000000_Gyeonggi_Hwaseong" || region == "4146500000_Gyeonggi_Yongin_Suji" || region == "4420000000_Chungcheongnamdo_Asan" || region == "4413100000_Chungcheongnamdo_Cheonan_Dongnam"){
        part_url = "https://www.realrankus.com/ad/" + region + "_ad.json" + update_ver
        ...
        */
        ...
        //part_url = "./ad/1000000000_Korea_ad.json" + update_ver
        $.getJSON(part_url, function(part_json) {
            partData = part_json;
            part_detail = partData.data
