...
$(document).ready(function () {
  ...
  $("body").append(
    "<div id='pageLoadingBack'><div class='spinner-grow text-pageLoading' role='status'></div><div style='font-size: 0.85em; color: white'><br>단지별 랭크를 계산하고 있어요!<br><br><div id='loading_reload' onClick='resetReload()'>로딩이 길다면 여기를 눌러 다시 불러오기!!</div></div></div>",
  );

  searching_url = "./" + selectedMonth + "/Searching_list.json" + update_ver;
  region_url = "./" + selectedMonth + "/region_map.json" + update_ver;
  ...
  request.onsuccess = (e) => {
    ...
    for (var i = 0; i < 9; i++) {
      if (i == 0) {
        ...
        filterHtml += `<div class='sPrice_index'>${i * 10}평</div>`;
      }
    }
    filterHtml += `
            </div>
    ...
    for (var i = 0; i < 5; i++) {
      if (i == 0) {
        ...
        filterHtml += `<div class='sPrice_index'>${i * 10}억</div>`;
      }
    }
    filterHtml += `
          </div>
...
function updateRegion() {
  ...
  $("body").append(
    "<div id='pageLoadingBack'><div class='spinner-grow text-pageLoading' role='status'></div><div style='font-size: 0.85em; color: white'><br>지역 정보를 불러오고 있어요!<br><br><div id='loading_reload' onClick='resetReload()'>로딩이 길다면 여기를 눌러 다시 불러오기!!</div></div></div>",
  );
  minValue = 0;
  maxValue = 60;
...
function showDetail(index) {
  ...
  if (Number(selectedMonth) > 202203 && (apt_type == "분양권" || apt_type == "분양(예정)")) {
    ...
    titleHtml += `
          <div class='popupSubtitle' style='font-size: 0.6em'>(신) ${aptAddress}</div>
          <div class='popupSubtitle' style='font-size: 0.6em'>(구) ${aptData.data[index]["법정동주소"]}</div>
        `;
  }
  detailHtml += `
        <div class='card'>
  ...
  detailHtml += `
              ...
              <div class='complex_like_name'>주거</div>
  ...
  if (isNaN(transportScore) == false) {
    detailHtml += `
                ...
                <div class='complex_like_name'>교통</div>
  ...
  detailHtml += `
              ...
              <div class='complex_like_name'>인프라</div>
  ...
  detailHtml += `
              ...
              <div class='complex_like_name'>교육</div>
  ...
  detailHtml += `
        ...
        <div class='popTitle' id='comment_popTitle'><div><i class='fa-regular fa-comment'></i>&nbsp&nbsp#개의 우리 단지 랭커스톡</div>
        <div></div>
        </div></div>
  ...
  if (login_status == false) {
    detailHtml += `
            <div class='loginBox'>
            <div id='aptrankLoginGuide'>더 자세한 정보와 분석을 확인하세요</div>
            <div id='aptrankLoginButton' data-bs-toggle='modal' data-bs-target='#loginModal' onClick='showLogin()'>리얼랭커스 로그인</div>
            </div>
          `;
  } else {
    detailHtml += `
    ...
    //detailHtml += "<hr class='hr_small'>";
    detailHtml += `<div class='card-body' style='padding-top: 2px'>`;
    if (selectedMonth == thisMonth) {
      detailHtml += `
            <div id='advanced_feature'>
            <div class='popupSubtitle' style='text-align: center; margin-top: 10px'>↓↓ 내 생각과 다르다면, 데이터를 바꿔 보세요! ↓↓</div>
            <div id='rankSimul' onclick='openSimulation(aptData.data,${index})'>랭크 시뮬레이션</div>
            <div id='btn_complex_compare' onclick='openCompare(aptData.data[${index}])'>단지 비교하기 <span id='newFeature'>NEW!!</span></div>
            </div>
          `;
    } else {
      detailHtml += `
  ...
  detailHtml += `
        <div class='card'>
        <div class='card-header'>
        <div class='popTitle'><i class='fa-solid fa-bullseye'></i>&nbsp&nbsp리얼레이더맵</div>
        </div>
  ...
  detailHtml += `
        ...
        <div id='aptrankLoginGuide' style='text-align:center; margin-top:5px'>지도를 선택하면 주변 입지를 확인할 수 있어요!</div>
        </div></div></div>
      `;
  ...
  detailHtml += `
        <div class='card'>
        <div class='card-header'>
        <div class='popTitle'><i class='fas fa-home'></i>&nbsp&nbsp주거</div>
        </div>
        <div class='card-body'>
        <div id='popLiving'>
      `;
  ...
  if (Number(selectedMonth) > 202203) {
    if (apt_type >= "재건축") {
      detailHtml += `
            <div class='popSubTable'><div class='popContent'>용적률</div><div class='popResult'>${floor_rate}</div></div>
            <div class='popSubTable'><div class='popContent'>건폐율</div><div class='popResult'>${cover_rate}</div></div>
          `;
    }
  } else {
    if (aptDuration >= 30) {
  ...
  if (Number(selectedMonth) > 202203) {
    detailHtml += `
          <div class='popSubTable' id='popSubStation'><div class='popContent'>주차</div><div class='popResult'>${parking}</div></div>
          <div class='popSubTable'><div class='popContent'>난방방식</div><div class='popResult'>${heating}</div></div>
          <div class='popSubTable'><div class='popContent'>현관구조</div><div class='popResult'>${entrance}</div></div>
        `;
  }
  ...
  if (Number(selectedMonth) > 202207 && apt_type != "분양(예정)") {
    if (floor_noise == "NA" || floor_noise == "" || floor_noise == null || floor_noise == undefined) {
      ...
      detailHtml += `
            <div class='card'>
            <div class='card-header'>
            <div class='popTitle'><i class='fa-solid fa-bell-slash'></i>&nbsp&nbsp층간소음</div>
            </div>
      ...
      detailHtml += `
            <div class='popSubTable'><div class='popContent'>층간소음 관리</div><div class='popResult'>${noise_level}</div></div>
            <div class='comment2' style='font-size: 0.7em'>층간소음 관리 정보는 층간소음 전문 연구소 <span style='color:#4542f5; font-weight:600'>주거문화개선연구소/층간소음에 안전한 아파트(앱)</span>에서 제공됩니다.</div>
            </div></div></div></div>
          `;
    }
  }
  ...
  if (isNaN(transportScore) == false) {
    ...
    detailHtml += `
          <div class='card'>
          <div class='card-header'>
          <div class='popTitle'><i class='fas fa-bus'></i>&nbsp&nbsp교통</div>
          </div>
          <div class='card-body'>
          <div id='popTransport'>
        `;
    ...
    detailHtml += `
          <div class='popTable'>
          <div class='popSubTable' id='popSubStation'><div class='popContent'>가장 가까운 역</div><div class='popResult'>${nearestStation}</div></div>
        `;
    if (Number(selectedMonth) > 202211) {
  ...
  detailHtml += `
        <div class='card'>
        <div class='card-header'>
        <div class='popTitle'><i class='fas fa-hospital-user'></i>&nbsp&nbsp인프라</div>
        </div>
        <div class='card-body'>
        <div id='popInfra'>
      `;
  ...
  detailHtml += `
        <div class='popTable'>
        <div class='popSubTable'><div class='popContent'>3km 이내 백화점</div><div class='popResult'>${departmentStore_3km}</div></div>
        <div class='popSubTable'><div class='popContent'>5km 이내 아울렛/몰</div><div class='popResult'>${OutletMall_5km}</div></div>
        <div class='popSubTable'><div class='popContent'>1km 이내 대형마트</div><div class='popResult'>${bigMart_1km}</div></div>
      `;
  ...
  detailHtml += `
        <div class='popSubTable'><div class='popContent'>500m 이내 은행</div><div class='popResult'>${bank_500m}</div></div>
        <div class='popSubTable'><div class='popContent'>500m 이내 병원</div><div class='popResult'>${hospital_500m}</div></div>
        <div class='popSubTable'><div class='popContent'>5km 이내 대형병원</div><div class='popResult'>${bigHospital_5km}</div></div>
        <div class='popSubTable'><div class='popContent'>500m 이내 공원</div><div class='popResult'>${park_500m}</div></div>
      `;
  ...
  detailHtml += `
        <div class='card'>
        <div class='card-header'>
        <div class='popTitle'><i class='fas fa-graduation-cap'></i>&nbsp&nbsp교육</div>
        </div>
        <div class='card-body'>
        <div id='popEducation'>
      `;
  ...
  detailHtml += `
        <div class='popSubTable'><div class='popContent'>초등학교 학생증감</div><div class='popResult'>${pSchool_edu_result}</div></div>
        <div class='popSubTable'><div class='popContent'>중학교 보통 학력 이상</div><div class='popResult'>${mSchool_edu}</div></div>
      `;
  if (Number(selectedMonth) > 202204 && Number(selectedMonth) <= 202206) {
    detailHtml += `
          <div class='popSubTable' style='grid-template-columns:1fr 1fr'><div class='popContent'>500m 이내 학원가</div><div class='popResult'>${academy_edu}</div></div>
          <div class='comment2'>교육 정보는 교육통계서비스 정보를 기반으로 산정되며, 학원가는 호갱노노의 정보를 사용합니다.<br>초등학교까지의 거리는 직선거리로 계산됩니다.</div>
        `;
  } else if (Number(selectedMonth) > 202206 && Number(selectedMonth) <= 202207) {
    detailHtml += `
          <div class='popSubTable' style='grid-template-columns:1fr 1fr'><div class='popContent'>500m 이내 학원가</div><div class='popResult'>${academy_edu}</div></div>
          <div class='popSubTable'><div class='popContent'>300m 이내 유흥시설/모텔</div><div class='popResult'>${drink_pub + daran_pub + motel}개</div></div>
          <div class='comment2'>교육 정보는 교육통계서비스 정보를 기반으로 산정되며,<br>학원가는 호갱노노의 정보를 사용합니다.<br>초등학교까지의 거리는 직선거리로 계산됩니다.<br>유흥시설과 모텔정보는 교육 감점요소로 적용됩니다.</div>
        `;
  } else if (Number(selectedMonth) > 202307 && Number(selectedMonth) <= 202208) {
    detailHtml += `
          <div class='popSubTable' style='grid-template-columns:1fr 1fr'><div class='popContent'>300m 이내 학원가</div><div class='popResult'>${academy_edu}</div></div>
          <div class='popSubTable'><div class='popContent'>300m 이내 유흥시설/모텔</div><div class='popResult'>${drink_pub + daran_pub + motel}개</div></div>
          <div class='comment2'>교육 정보는 교육통계서비스 정보를 기반으로 산정되며,<br>학원가는 호갱노노의 정보를 사용합니다.<br>초등학교까지의 거리는 직선거리로 계산됩니다.<br>유흥시설과 모텔정보는 교육 감점요소로 적용됩니다.</div>
        `;
    ...
    detailHtml += `
          <div class='popSubTable' style='grid-template-columns:1fr 1fr'><div class='popContent'>300m 이내 학원가</div><div class='popResult'>${academy_edu}</div></div>
          <div class='popSubTable' style='grid-template-columns:1fr 1fr'><div class='popContent'>1km 이내 학원가</div><div class='popResult'>${academy_edu_long}</div></div>
          <div class='popSubTable'><div class='popContent'>300m 이내 유흥시설/모텔</div><div class='popResult'>${drink_pub + daran_pub + motel}개</div></div>
          <div class='comment2'>교육 정보는 교육통계서비스 정보를 기반으로 산정되며,<br>학원가는 호갱노노의 정보를 사용합니다.<br>초등학교까지의 거리는 직선거리로 계산됩니다.<br>유흥시설과 모텔정보는 교육 감점요소로 적용됩니다.</div>
        `;
  } else {
  ...
  if (apt_type != "분양(예정)") {
    ...
    detailHtml += `
          ...
          <div class='popContent'>최근 매매</div>
        `;
    ...
    if (Number(selectedMonth) > 202207) {
      detailHtml += `
            <th scope='col' style='line-height: 2.9em;'>평형</th>
            <th scope='col'>매매 실거래가<br>전세 실거래가</th>
            <th scope='col'>평단가<br>전세가율</th>
          `;
    } else {
      detailHtml += `
            <th scope='col'>평형</th>
    ...
    for (var k = 0; k < area_array.length; k++) {
      ...
      if (sales_info_array[k] == "거래 정보 없음") {
        ...
        if (Number(selectedMonth) > 202207) {
          ...
          if (compare_date > start_date) {
            detailHtml += `
                  <td><span style='color:#fe4040; font-weight:600'>${area_array[k]}</span></td>
                  <td><span style='color:#fe4040; font-weight:600'>${(Math.round(sales_info_split[0] * 100) / 100).toFixed(2)}억<span style='font-size: 0.85em'>${sales_info_split[1]}</span></span><br>
                `;
          } else {
            detailHtml += `
                  <td>${area_array[k]}</td>
                  <td>${(Math.round(sales_info_split[0] * 100) / 100).toFixed(2)}억<span style='font-size: 0.85em'>${sales_info_split[1]}</span><br>
                `;
          }
          ...
          if (compare_date > start_date) {
            detailHtml += `
                  <td><span style='color:#fe4040; font-weight:600'>${area_array[k]}</span></td>
                  <td><span style='color:#fe4040; font-weight:600'>${(Math.round(sales_info_split[0] * 100) / 100).toFixed(2)}억<span style='font-size: 0.85em'>${sales_info_split[1]}</span></span></td>
                `;
          } else {
            detailHtml += `
                  <td>${area_array[k]}</td>
                  <td>${(Math.round(sales_info_split[0] * 100) / 100).toFixed(2)}억<span style='font-size: 0.85em'>${sales_info_split[1]}</span></td>
                `;
          }
        }
      }
      ...
      if (price_per_array[k] == "nan" || price_per_array[k] == 0) {
        ...
        if (compare_date > start_date) {
          detailHtml += `<td><span style='color:#fe4040; font-weight:600'>${price_per.toLocaleString()}만원</span><br>`;
        } else {
          detailHtml += `<td>${price_per.toLocaleString()}만원<br>`;
        }
      }
    ...
    detailHtml += `
          ...
          <div class='comment2'>&nbsp&nbsp실거래가 정보는 네이버 부동산으로 취득합니다.</div>
          </div></div></div></div>
        `;
  }
  ...
  if (apt_type != "분양(예정)") {
    ...
    detailHtml += `
          <div class='card'>
          <div class='card-header'>
          <div class='popPriceTitle'><i class='fa-solid fa-chart-line'></i>&nbsp&nbsp매매가변동<span id='themeLogo'>BETA</span></div>
          </div>
        `;
    ...
    detailHtml += `
          ...
          <label for='showGraph' style='font-size: 0.85em; padding-left: 3px'>그래프보기</label></input></div>
    ...
    for (var p = 0; p < area_array.length; p++) {
      ...
      detailHtml += `
            ...
            <div class='priceResult' style='padding-left: 5px'>${area_array[p]}</div>
      ...
      if (showGraph) {
        ...
        detailHtml += `
              <div class='priceResult' style='text-align: right; padding-right: 4px'>거래 정보 없음</div>
 ...
 */
function showGraphCarousel() {
  graph_url = "./regional_graph/" + selectedSubRegion + "/graph_list.json";
  basePath = "./regional_graph/" + selectedSubRegion + "/";
